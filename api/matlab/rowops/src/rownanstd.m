%   ROWNANSTD -- Standard deviation across rows, for each subset of data,
%     excluding NaN.
%
%     devs = rownanstd( data, I ) returns `devs` across rows of `data` for 
%     each subset of rows identified by an index in `I`, excluding elements
%     that are NaN.
%
