...
build_cmd = sprintf( '-v %s CXXFLAGS="-std=%s%s" COPTIMFLAGS="-O3 -fwrapv -DNDEBUG" CXXOPTIMFLAGS="-O3 -fwrapv -DNDEBUG" %s -I%s -l%s -L%s -outdir %s' ...
  , compiler_spec, cxx_std, addtl_flags, mex_func_path, cat_include_dir ...
