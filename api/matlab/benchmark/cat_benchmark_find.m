...
results_eq_match_category_behavior = cat_benchmark_run( @(i) mat_eq_match_category_behavior(f, c, cats, selectors, i) ...
  , 'name', 'mat-find-equivalent' ...
  , common_inputs{:} ...
);

results = [ results_f; results_eq_match_category_behavior ];
